...
export function HabitDay({amountOfhabits = 0, completed = 0, date, ...rest}: Props) {
  const amountAccomplishedPercentage =  amountOfhabits > 0 ? generateProgressPercentage(amountOfhabits, completed) : 0
